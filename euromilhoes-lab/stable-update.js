(()=>{
'use strict';
const APP_VERSION='4.3.0';let lastCheck=0,checking=false;
...
async function loadModules(){try{await loadScript('ed-store.js');await loadScript('ed-base.js');await loadScript('ed-ui.js');await loadScript('simple-ui.js')}catch(err){console.warn('Módulo Euro Lab indisponível:',err)}}
